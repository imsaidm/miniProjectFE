  ...
  return (
    <div className="min-h-screen bg-gradient-primary">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 container-hero">
          <div className="text-center mb-16">
            <div className="hero-badge mb-8">
              ...
              <span className="text-white text-lg font-medium">Discover Amazing Events</span>
            </div>
         ...
         <div className="glass-card mb-16 p-8">
           <div className="text-center mb-8">
             <h2 className="section-title text-3xl md:text-4xl mb-4">Find Your Perfect Event</h2>
             <p className="section-subtitle text-lg">Use our advanced filters to discover events that match your interests</p>
           </div>
           ...
           <div className="mb-8">
             <div className="relative max-w-4xl mx-auto">
               ...
               <input
                 ...
                 className="form-input pl-16 pr-6 py-5 text-xl w-full"
               />
             </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
             <div className="form-group">
               <label className="form-label text-sm font-semibold mb-2 block">Category</label>
               <select
                 value={selectedCategory}
                 onChange={(e) => handleCategoryChange(e.target.value)}
                 className="px-4 py-3 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-xl focus:ring-4 focus:ring-yellow-400/50 focus:outline-none transition-all duration-300 w-full"
               >
             ...
             <div className="form-group">
               <label className="form-label text-sm font-semibold mb-2 block">Location</label>
               <select
             ...
             <div className="form-group">
               <label className="form-label text-sm font-semibold mb-2 block">Date</label>
               <input
                 type="date"
                 value={selectedDate}
             ...
             <div className="form-group">
               <label className="form-label text-sm font-semibold mb-2 block">Price Range</label>
               <select
                 value={priceRange}
             ...
             <div className="form-group">
               <label className="form-label text-sm font-semibold mb-2 block">Sort By</label>
               <select
                 value={sortBy}
        ...
        {hasActiveFilters && (
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-6 py-3 glass rounded-2xl border border-white/20">
          ...
          <div className="grid-cards">
            {sortedEvents.map((event, index) => (
              ...
              >
                ...
                {/* Event Content */}
                <div>
                  <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-yellow-400 transition-colors duration-300 line-clamp-2">
                    {event.title}
                  </h3>
